...
class KitSounds():
	...
	leftFoot = ["Tom_808_H",  #:128 #01/Tom_8.wav
	...
	backbeat = ["Snare_110", #103 #01/Snare.wav
	...
	perc = ["Clap_Hse2", #:4 #00/Clap__04.wav
...
def generate(r, m, t):
	...
	k.pads.append({"sound": wav[KitSounds.any(KitSounds.cym)]})
	...
	k.pads.append({"sound": wav[KitSounds.any(KitSounds.perc)]})
	...
	k.pads.append({"sound": wav[KitSounds.any(KitSounds.leftFoot + KitSounds.backbeat)]})
	k.pads.append({"sound": wav[KitSounds.any(KitSounds.backbeat)]})
	k.pads.append({"sound": wav[KitSounds.any(KitSounds.perc)]})
